...
/// </summary>
public class AppendOnlyFileStorageEngineWithIndexBenchmark : KeyValueStoreBenchmark<SerializableWrapper<int>, SerializableWrapper<string>>
{
    /// <summary>
    ...
    public AppendOnlyFileStorageEngineWithIndexBenchmark()
    {
        ...
        SetStore(new AppendOnlyFileStorageEngineWithIndex<SerializableWrapper<int>, SerializableWrapper<string>>(databaseFilePath, entrySerializer, index));
    }
}
